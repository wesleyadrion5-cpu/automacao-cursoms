...
DB_PATH = os.path.join(BASE_DIR, "banco_frota.db")
                ...
                for tentativa in range(2):
                    ...
                    try:
                        ...
                        if modo_exige_modulo_existente and modulo_existente:
                            ...
                            self._trocar_para_janela_segura(aba_nova, "mÃ³dulo existente no site novo")
...
class AppPrincipal(ctk.CTk):
    ...
    def iniciar_robo_principal(self):
        for widget in self.winfo_children():
            widget.destroy()
        self.title("Isaura V106 - The Livewire Whisperer")
...
class MotorRobo:
    def __init__(self, root, config_carregada):
        ...
        self.module_scope = str(self.config.get("module_scope", "todos") or "todos")
    ...
    def atualizar_botoes_modo(self):
        ...
        if hasattr(self, "frame_modulo_unico"):
            if self.module_scope == "unico":
                self.frame_modulo_unico.pack(fill="x", padx=20, pady=(0, 10), before=self.actions_frame)
            else:
    ...
    def setup_ui(self):
        ...
        for modo, escopo, texto in [
            ("completo", "todos", "PLANILHA ACIMA - SUBIR VARIOS MODULOS"),
            ("videos", "unico", "VIDEO DE UM MODULO"),
            ("materiais", "unico", "MATERIAIS DE UM MODULO"),
            ("completo", "unico", "SUBIR TODO O MODULO"),
        ]:
            botao = ctk.CTkButton(
                presets_frame,
                text=texto,
    ...
    def _setup_ui_stitch(self):
        ...
        ctk.CTkLabel(
            ...
            text_color="#3B82F6" if dark_theme else "#1D4ED8",
        ...
        ctk.CTkLabel(
            ...
            text="[CPU]",
            font=("Space Grotesk", 20, "bold"),
            text_color="#B4C5FF" if dark_theme else "#1D4ED8",
        ...
        card_title(modos_frame, "[>]", "MODOS DE EXECU\u00c7\u00c3O", accent="#FFB95F")
        ctk.CTkLabel(
            modos_frame,
            text="Escolha um preset. O primeiro usa planilha; os outros agem no m\u00f3dulo j\u00e1 criado.",
            font=("Inter", 12),
            text_color=_muted,
            justify="left",
            wraplength=520,
        ...
        self.botoes_preset = {}
        for modo, escopo, texto in [
            ("completo", "todos", "PLANILHA ACIMA - SUBIR V\u00c1RIOS M\u00d3DULOS"),
            ("videos", "unico", "V\u00cdDEO DE UM M\u00d3DULO"),
            ("materiais", "unico", "MATERIAIS DE UM M\u00d3DULO"),
            ("completo", "unico", "SUBIR TODO O M\u00d3DULO"),
        ]:
            botao = ctk.CTkButton(
                presets_frame,
                text=texto,
